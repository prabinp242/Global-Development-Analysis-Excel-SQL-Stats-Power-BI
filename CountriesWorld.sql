...
-- Count null values
select
    sum(case when Net_Migration is null then 1 else 0 end) as Null_Net_Migration,
    sum(case when Infant_Mortality is null then 1 else 0 end) as Null_Infant_Mortality,
    sum(case when GDP_Per_Capita is null then 1 else 0 end) as Null_GDP,
    sum(case when Literacy is null then 1 else 0 end) as Null_Literacy,
    sum(case when Climate is null then 1 else 0 end) as Null_Climate,
    sum(case when Birthrate is null then 1 else 0 end) as Null_Birthrate,
    sum(case when Deathrate is null then 1 else 0 end) as Null_Deathrate,
    sum(case when Service is null then 1 else 0 end) as Null_Service,
    sum(case when Agriculture is null then 1 else 0 end) as Null_Agriculture,
...
from Countries_World order by GDP_per_Capita desc;
...
SELECT Country, Infant_Mortality,GDP_per_Capita 
FROM Countries_World
WHERE GDP_per_Capita < 2000 
  AND Infant_Mortality > 50
